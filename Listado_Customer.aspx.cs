...
{
    public partial class Listado_Customer : System.Web.UI.Page
    {
        ...
        protected void RPT_CUSTOMER_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
                ...
                case "ELIMINAR":
                        ...
                        try
                    {
                        using (SqlConnection conexion = new SqlConnection(ConfigurationManager.ConnectionStrings["Operaciones.Properties.Settings.CONEXION"].ToString()))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand("SP_DELETE_CUSTOMER", conexion);
                            cmd.CommandType = CommandType.StoredProcedure;
                            cmd.Parameters.Add(new SqlParameter("@ID_CUSTOMER", num));
                            ...
                            else
                            {
                                ...
                                MENSAJE_ERROR.Text = "EL PROCEDIMIENTO EXEC SP_DELETE_CUSTOMER " + num + " FUE ERRONEO";
                            }
                        }
                    }
                    catch (Exception EX)
                    ...
                    break;
                case "EDITAR":
                    Response.Redirect("~/Crear_Customer.aspx?NRO_ID=" + num + "");
                    break;
            }
