<%@ Page Title="" Language="C#" MasterPageFile="~/Home_Master.Master" AutoEventWireup="true" CodeBehind="Crear_Usuario.aspx.cs" Inherits="Operaciones.Crear_Usuario" %>
...
<div class="container">
  ...
  <div class="panel-group">
    <div class="panel panel-primary">
      <div class="panel-heading text-bold"><h4> REGISTRAR USUARIO   </h4> </div>
      <div class="panel-body">
         ...
         <div class="row">
              ...
              <div class="col-md-4">
                     <div class="form-group">
                     <label for="pwd">MODIFICAR:</label>
                     <div class="input-group">
                     <input runat="server" id="CHK_MODIFICAR" data-on="SI" data-off="NO" type="checkbox"  data-toggle="toggle" data-style="slow">
                     </div>
                     </div>
                  </div>
         ...
         <div class="row">
                ...
                <div class="col-md-4">
                     ...
                     <asp:TextBox ID="TXT_USUARIO" runat="server" class="form-control" name="password" placeholder="(OBLIGATORIO)" REQUIRED></asp:TextBox>
                     </div>
                     </div>
                 </div>
                ...
                <div class="col-md-4">
                     ...
                     <asp:TextBox ID="TXT_CONTRASEÑA" runat="server" TextMode="Password" class="form-control" name="password" placeholder="(OBLIGATORIO)" REQUIRED></asp:TextBox>
                     </div>
                     </div>
                 </div>
                ...
                <div class="col-md-4">
                     <div class="form-group">
                     <label for="pwd">ELIMINAR:</label>
                     <div class="input-group">
                     <input runat="server" id="CHK_ELIMINAR" data-on="SI" data-off="NO" type="checkbox"  data-toggle="toggle" data-style="slow">
                     </div>
                     </div>
                 </div>
