...
{
    public partial class Crear_Agente : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ID_AGENTE.Text = VALOR_SOLICITUD.ToString();
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        {
                            SqlCommand cmd = new SqlCommand("SP_READ_AGENTE_X_SOLICITUD", conexion);
                            cmd.CommandType = CommandType.StoredProcedure;
                            cmd.Parameters.Add(new SqlParameter("@ID_AGENTE", VALOR_SOLICITUD));
                            conexion.Open();
                            ...
                            if (dr.Read())
                            {
                                ...
                                TXT_COD_POSTAL.Text = dr["COD_POSTAL"].ToString();
                                DDL_PAIS.SelectedValue = dr["ID_PAIS"].ToString();
        ...
        protected void BTN_GUARDAR_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection conexion = new SqlConnection(ConfigurationManager.ConnectionStrings["Operaciones.Properties.Settings.CONEXION"].ToString()))
                {
                    SqlCommand cmd = new SqlCommand("SP_CREATE_AGENTE", conexion);
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    cmd.Parameters.Add(new SqlParameter("@ID_CIUDAD", TXT_CIUDAD.Text));
                    cmd.Parameters.Add(new SqlParameter("@DIRECCION", TXT_DIRECCION.Text));
                    cmd.Parameters.Add(new SqlParameter("@EMAIL", TXT_EMAIL.Text));
                    cmd.Parameters.Add(new SqlParameter("@COD_POSTAL", TXT_COD_POSTAL.Text));
                    cmd.Parameters.Add(new SqlParameter("@ID_PAIS", DDL_PAIS.SelectedValue.ToString()));
                    ...
                    if (VALOR > 0)
                    {
                        ...
                        MENSAJE_CORRECTO.Text = "AGENTE :   " + TXT_NOMBRE.Text + ",FUE CREADO CORRECTAMENTE ";
                    ...
                    else
                    {
                        ...
                        CUADRO_CORRECTO.Visible = false;
                        CUADRO_ERROR.Visible = true;
                        MENSAJE_ERROR.Text = "ERROR AL REGISTRAR DATOS , REVISAR SP_CREATE_AGENTE DEVOLVIO RETURN 0";
                    }
                }
            }
            catch (Exception EX)
        ...
        protected void BTN_ACTUALIZAR_Click(object sender, EventArgs e){
            ...
            if (VAR){
                try{
                    ...
                    using (SqlConnection conexion = new SqlConnection(ConfigurationManager.ConnectionStrings["Operaciones.Properties.Settings.CONEXION"].ToString()))
                    {
                        SqlCommand cmd = new SqlCommand("SP_UPDATE_AGENTE", conexion);
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@ID_AGENTE", ID_AGENTE.Text));
                        cmd.Parameters.Add(new SqlParameter("@NOMBRE", TXT_NOMBRE.Text));
                        cmd.Parameters.Add(new SqlParameter("@RUT", TXT_RUT.Text));
                        cmd.Parameters.Add(new SqlParameter("@TELEFONO_1", TXT_TELEFONO1.Text));
                        cmd.Parameters.Add(new SqlParameter("@TELEFONO_2", TXT_TELEFONO2.Text));
                        ...
                        else
                        {
                            ...
                            CUADRO_CORRECTO.Visible = false;
                            CUADRO_ERROR.Visible = true;
                            MENSAJE_ERROR.Text = "EL PROCEDIMIENTO SP_UPDATE_AGENTE DEVOLVIO ERROR AL ACTUALIZAR";
                        }
                    }
                }catch (Exception EX){
                    BTN_ACTUALIZAR.Enabled = true;
