...
{
    public partial class Listado_Comercial : System.Web.UI.Page
    {
        ...
        protected void RPT_COMERCIAL_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
                ...
                case "ELIMINAR":
                        ...
                        try
                    {
                        using (SqlConnection conexion = new SqlConnection(ConfigurationManager.ConnectionStrings["Operaciones.Properties.Settings.CONEXION"].ToString()))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand("SP_DELETE_COMERCIAL", conexion);
                            cmd.CommandType = CommandType.StoredProcedure;
                            cmd.Parameters.Add(new SqlParameter("@ID_COMERCIAL", num));
                            ...
                            if (VALOR == 1)
                            {
                                LIST_COMERCIAL.DataBind();
                                RPT_COMERCIAL.DataBind();
                            ...
                            else
                            {
                                ...
                                MENSAJE_ERROR.Text = "EL PROCEDIMIENTO EXEC SP_DELETE_COMERCIAL " + num + " FUE ERRONEO";
                            }
                        }
                    }
                    catch (Exception EX)
                    ...
                    break;
                case "EDITAR":
                    Response.Redirect("~/Crear_Comercial.aspx?NRO_ID=" + num + "");
                    break;
            }
