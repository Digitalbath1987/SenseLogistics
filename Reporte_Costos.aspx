<%@ Page Title="" Language="C#" MasterPageFile="~/Home_Master.Master" AutoEventWireup="true" CodeBehind="Reporte_Costos.aspx.cs" Inherits="Operaciones.Reporte_Costos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <div class="panel-heading text-bold"><h4> REPORTE DE COSTOS X FECHA DE OPERACION</h4> </div>
      ...
      <div class="row">
          <div class="col-sm-12">
           <div class="table-responsive">          
              ...
              <th class="small" >TIPO CONCEPTO</th>
              ...
              <tr>
                ...
                <td class="small" ><%# Eval("CONCEPTO") %></td>
                <td class="small" ><%# Eval("TIP_CONCEPTO") %></td>
                <td class="small" ><%# Eval("MONTO_CLP") %></td>
                <td class="small hidden-sm col-sm-1"><asp:Button ID="BTN_VER_VALORACION" CommandName="VALORACION" CommandArgument='<%# Eval("ID_OPERACIONES") %>'  ToolTip="¿ VER DETALLE DE VALORACION ?" data-toggle="tooltip"   class=" btn  btn-success" runat="server" Text='V' /> <asp:Button ID="BTN_VER_OPERACION" CommandName="OPERACION" CommandArgument='<%# Eval("ID_OPERACIONES") %>'  ToolTip="¿ VER DETALLE DE OPERACION  ?" data-toggle="tooltip"  class=" btn btn-primary" runat="server" Text='O'/>  </td>
              </tr>
              </ItemTemplate>
              </asp:Repeater>
              </tbody>
