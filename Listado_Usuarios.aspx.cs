...
namespace Operaciones
{
    public partial class Listado_Usuarios : System.Web.UI.Page
    {
        ...
        protected void RPT_USUARIOS_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "ELIMINAR":
                        ...
                        try
                    {
                        ...
                        {
                            SqlCommand cmd = new SqlCommand("SP_DELETE_USUARIOS", conexion);
                            cmd.CommandType = CommandType.StoredProcedure;
                            cmd.Parameters.Add(new SqlParameter("@ID_USUARIOS", num));
                            ...
                            if (VALOR == 1)
                            {
                                ...
                                MENSAJE_CORRECTO.Text = "EL USUARIO N° : " + num + " FUE DESHABILITADO CORRECTAMENTE";
                            }
                            else
                            {
            ...
            break;
                case "EDITAR":
                    Response.Redirect("~/Crear_Usuario.aspx?NRO_ID=" + num + "");
                    break;
            }
