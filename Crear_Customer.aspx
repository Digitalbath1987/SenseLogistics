<%@ Page Title="" Language="C#" MasterPageFile="~/Home_Master.Master" AutoEventWireup="true" CodeBehind="Crear_Customer.aspx.cs" Inherits="Operaciones.Crear_Customer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
  ...
  <div class="panel-group">
    <div class="panel panel-primary">
      <div class="panel-heading text-bold"><h4> CREAR CUSTOMER  </h4> </div>
      <div class="panel-body">
         <asp:Label ID="ID_CUSTOMER" Visible="false"  runat="server" Text="0"></asp:Label>
         ...
         <div class="row">
               ...
               <div class="col-md-4">
                    <asp:Button ID="BTN_GUARDAR" Visible="false" runat="server" Text="CREAR CUSTOMER"  OnClick="BTN_GUARDAR_Click" class="btn btn-primary" data-toggle="tooltip" title="Click Para Guardar" /> 
                    <asp:Button ID="BTN_ACTUALIZAR" Visible="false" runat="server" Text="ACTUALIZAR CUSTOMER" OnClick="BTN_ACTUALIZAR_Click"  class="btn btn-primary"  data-toggle="tooltip" title="Click Para Actualizar" />
               </div>
