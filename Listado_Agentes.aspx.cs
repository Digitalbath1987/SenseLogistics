...
{
    public partial class Listado_Agentes : System.Web.UI.Page
    {
        ...
        protected void RPT_AGENTES_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "ELIMINAR":
                    ...
                    if (VAR)
                    {
                        ...
                        try
                        {
                            using (SqlConnection conexion = new SqlConnection(ConfigurationManager.ConnectionStrings["Operaciones.Properties.Settings.CONEXION"].ToString()))
                            {
                                ...
                                SqlCommand cmd = new SqlCommand("SP_DELETE_AGENTE", conexion);
                                cmd.CommandType = CommandType.StoredProcedure;
                                cmd.Parameters.Add(new SqlParameter("@ID_AGENTE", num));
                                ...
                                else
                                {
                                    ...
                                    MENSAJE_ERROR.Text = "EL PROCEDIMIENTO EXEC SP_DELETE_AGENTE " + num + " FUE ERRONEO";
                                }
                            }
                        }
                        catch (Exception EX)
                    ...
                    break;
                case "EDITAR":
                    Response.Redirect("~/Crear_Agente.aspx?NRO_ID=" + num + "");
                    break;
            }
