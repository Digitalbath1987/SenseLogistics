<%@ Page Title="" Language="C#" MasterPageFile="~/Home_Master.Master" AutoEventWireup="true" CodeBehind="Crear_Agente.aspx.cs" Inherits="Operaciones.Crear_Agente" %>
...
<div class="container">
  ...
  <div class="panel-group">
    <div class="panel panel-primary">
      <div class="panel-heading text-bold"><h4> REGISTRAR AGENTE   </h4> </div>
      <div class="panel-body">
         <asp:Label ID="ID_AGENTE" Visible="false"  runat="server" Text="0"></asp:Label>

         <div class="row">
       
              <div class="col-md-4">
                     <div class="form-group">
                     <label for="pwd">NOMBRE AGENTE:</label>
         ...
         <div class="row">
                ...
                <div class="col-md-4">
                     ...
                     <div class="input-group">
                     <span class="input-group-addon"><i class="fas fa-map-marked-alt"></i></span>
                     <asp:TextBox ID="TXT_CIUDAD" runat="server" class="form-control" name="password" placeholder="(OBLIGATORIO)" REQUIRED></asp:TextBox>
                     </div>
                     </div>
                 </div>
               ...
               <div class="col-md-4">
                     ...
                     <asp:DropDownList ID="DDL_PAIS" data-live-search="true" data-live-search-style="startsWith" class="form-control selectpicker" runat="server" DataSourceID="LISTADO_PAISES" DataTextField="PAIS" DataValueField="ID_PAIS"></asp:DropDownList>
                     <asp:SqlDataSource runat="server" ID="LISTADO_PAISES" ConnectionString='<%$ ConnectionStrings:Operaciones.Properties.Settings.CONEXION %>' SelectCommand="SELECT ID_PAIS,PAIS FROM PAIS WITH(NOLOCK) ORDER BY PAIS ASC"></asp:SqlDataSource>
                     </div>
                     </div>
                 </div>
          ...
          <div class="row">
               ...
               <div class="col-md-4">
                     ...
                     <div class="input-group">
                     <span class="input-group-addon"><i class="fas fa-mobile-alt"></i></span>
                     <asp:TextBox ID="TXT_COD_POSTAL" runat="server" class="form-control" name="password" placeholder="(OBLIGATORIO)" REQUIRED></asp:TextBox>
                     </div>
                     </div>
                 </div>
          ...
          <div class="row">
                ...
                <div class="col-md-4">
                <asp:Button ID="BTN_ACTUALIZAR" Visible="false" runat="server" Text="ACTUALIZAR AGENTE" OnClick="BTN_ACTUALIZAR_Click"  class="btn btn-primary"  data-toggle="tooltip" title="Click Para Actualizar" />
             <asp:Button ID="BTN_GUARDAR" Visible="false" runat="server" Text="CREAR AGENTE" OnClick="BTN_GUARDAR_Click"  class="btn btn-primary" data-toggle="tooltip" title="Click Para Guardar" /> 
                    </div>
